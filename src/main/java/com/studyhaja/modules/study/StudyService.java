...
import static com.studyhaja.modules.study.form.StudyForm.VALID_PATH_PATTERN;
...
//        eventPublisher.publishEvent(new StudyCreatedEvent(newStudy));
    ...
    private void checkIfStudyExists(String path, Study study) {
        if (study == null) {
    ...
    public Study getStudyToEnroll(String path) {
        Study study = studyRepository.findOnlyStudyByPath(path);
        checkIfStudyExists(path, study);
        return study;
    }
}
